...
- Preferred: open a private [GitHub Security Advisory](https://github.com/jotaele44/ovnis-pr/security/advisories/new)
  for this repository.
...
This policy covers the `ovnis-pr` source code and its CI/CD configuration.
